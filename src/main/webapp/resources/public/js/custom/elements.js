...
jQuery(document).ready(function(){
	...
	///// DATE PICKER /////
	jQuery( "#datepicker_d" ).datepicker();
	jQuery( "#datepicker" ).datepicker();
	jQuery( "#datepickerinvoiceDate" ).datepicker();
	jQuery( "#datepickerDueDate" ).datepicker();
	jQuery( "#datepickerGLDate" ).datepicker();
	jQuery( "#datepickerto" ).datepicker();

	jQuery( "#datepickerdate" ).datepicker();

	jQuery( "#datepicker_x" ).datepicker();

	jQuery( "#datepickerinvoice" ).datepicker();

	jQuery( "#datepickerrom" ).datepicker();
